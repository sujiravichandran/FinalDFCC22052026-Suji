...
public class SessionToStagesMappingDTO {
	...
	public String getStagelLevelId() {
		return stagelLevelId;
	}

	public void setStagelLevelId(String stagelLevelId) {
		this.stagelLevelId = stagelLevelId;
	}
