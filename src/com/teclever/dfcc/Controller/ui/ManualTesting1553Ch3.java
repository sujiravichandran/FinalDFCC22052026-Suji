...
class ManualTesting1Ch3DataTableViewFactory implements TableViewFactory<Ch11553Table1> {
	@Override
...
class ManualTesting2Ch3DataTableViewFactory implements TableViewFactory<Ch11553Table2> {
	@Override
...
public class ManualTesting1553Ch3 {
	...
	private Label chLabel = new Label("DFCC CHANNEL 3");
		...
		Task<Void> task = new Task<Void>() {
			...
			protected Void call() throws Exception {
				...
				List<RDF1553BCode> dataList = dataAnalysis1553_BManagement.get1553BValuesForChannel(DFCCConstant.selectedSessionId1553,
						DFCCConstant.selectedStageId1553, "ch3");
					...
					ch11553Table1DataTableView.getColumns().forEach(column -> {
						...
						case "TTR1_I":
							...
							if(uutId.equalsIgnoreCase("UUT1")) {
								mainHeader = new Label("TTR3_I Contents of 003C C03C\n(Decimal)");
							}else {
							 mainHeader = new Label("TTR3_I Contents of 206C C03C\n(Decimal)");
							}
						...
						case "TTR1_II":
							...
							Label mainHeader1;
							if(uutId.equalsIgnoreCase("UUT1")) {
								mainHeader1 = new Label("TTR3_II Contents of 003C C07C\n(Decimal)");
							}else {
							 mainHeader1 = new Label("TTR3_II Contents of 206C C07C\n(Decimal)");
							}
						...
						case "TTR1_III":
							...
							Label mainHeader2;
							if(uutId.equalsIgnoreCase("UUT1")) {
								mainHeader2 = new Label("TTR3_III Contents of 003C C03BC\n(Decimal)");
							}else {
							 mainHeader2 = new Label("TTR3_III Contents of 206C C0BC\n(Decimal)");
							}
						...
						case "TTR1_IV":
							...
							Label mainHeader3;
							if(uutId.equalsIgnoreCase("UUT1")) {
								mainHeader3 = new Label("TTR3_IV Contents of 003C C0FC\n(Decimal)");
							}else {
							 mainHeader3 = new Label("TTR3_IV Contents of 206C C0FC\n(Decimal)");
							}
						...
						case "TTR1_V":
							...
							Label mainHeader4;
							if(uutId.equalsIgnoreCase("UUT1")) {
								mainHeader4 = new Label("TTR3_V Contents of 306C C13C\n(Decimal)");
							}else {
							 mainHeader4 = new Label("TTR3_V Contents of 206C C13C\n(Decimal)");
							}
						...
						case "TTR1_VI":
							...
							Label mainHeader5;
							if(uutId.equalsIgnoreCase("UUT1")) {
								mainHeader5 = new Label("TTR3_VI Contents of 306C C17C\n(Decimal)");
							}else {
							 mainHeader5 = new Label("TTR3_VI Contents of 206C C17C\n(Decimal)");
							}
						...
						case "TTR1_VII":
							...
							Label  mainHeader6;
							if(uutId.equalsIgnoreCase("UUT1")) {
								mainHeader6 = new Label("TTR3_VII Contents of 306C C1BC\n(Decimal)");
							}else {
							 mainHeader6 = new Label("TTR3_VII Contents of 206C C1BC\n(Decimal)");
							}
