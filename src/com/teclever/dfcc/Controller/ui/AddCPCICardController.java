...
public class AddCPCICardController {

	@FXML
	private AnchorPane addCpciCardContainer;

	@FXML
	private VBox addCpciCardForm;

	@FXML
	private HBox addCpciCardFormHeading;

	@FXML
	private HBox buttonBox;

	@FXML
	private VBox cardIdentificationBox;

	@FXML
	private Label cardIdentificationLabel;

	@FXML
	private TextField cardIdentificationtField;

	@FXML
	private VBox cardNameBox;
	...
	@FXML
	private TextField totalCardTextField;
	...
	private void createAddCpciCardPopup(int aitessId) {
		...
		totalCardTextField.addEventFilter(KeyEvent.KEY_TYPED, event -> {
	...
	private void setEditCardData() {
		...
		if (cardData != null) {
			headerLabel.setText("UPDATE cPCI CARD");
			cardNameTextField.setText(cardData.getCardName());
			cardIdentificationtField.setText(cardData.getCardIdentificationText());
