...
public class LinkFilesController {
	...
	private Label pageHeading = new Label("Link Files");
	...
	public GridPane createlinkFilesMainContainerGridPane() {
		...
		linkFilesMainContainerGridPane.getStyleClass().add("dashboard-main-container");
		...
		linkFilesMainContainerGridPane.getRowConstraints().addAll(firstRow, secondRow);
		linkFilesMainContainerGridPane.setPadding(new Insets(10, 10, 10, 10));

		linkFilesMainContainerGridPane.add(headingGridPane(), 0, 0, 2, 1);
